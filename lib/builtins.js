module.exports = {
  ...
  'inherit': 'function(x){return Object.create(x);}',
  ...
  'rest': 'function(x){return [].slice.call(x,1);}',
  'initial': 'function(x){return [].slice.call(x,0,x.length-1);}',
  ...
  'type': 'function(x){return (typeof(x) === "number" && x !== x) ? "NaN" : typeof(x) === "undefined" ? "Undefined" : x === null ? "Null" : x.__proto__.constructor.name;}',
  'string': 'function(x){return x.toString();}',
  'number': 'function(x){return parseFloat(x);}',
  'integer': 'function(x){return Math.floor(parseFloat(x));}',
...
module.exports['car'] = module.exports['first'];
module.exports['cdr'] = module.exports['rest'];
module.exports['cadr'] = module.exports['second'];
