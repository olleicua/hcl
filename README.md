...
Subtracts the subtrahend from the value associated with the specified
key in the object and returns the new value.
...
Multiplies the value associated with the specified key in the object
by the factor and returns the new value.
...
Divides the value associated with the specified key in the object
by the divisor and returns the new value.
